...
@section('content')
    <section class="inn">
        <div class="container">
            <div class="no-print">
                <button type="button" class="btn btn-primary" style="float: right" onclick="window.print()">Cetak Hasil
                    Diagnosa</button>
            </div>
            ...
            <div class="just-print">
                <p>*) Hasil diagnosa dapat ditunjukan ke Puskeswan Batang</p>
                </p>
            </div>
        </div>
    </section>
