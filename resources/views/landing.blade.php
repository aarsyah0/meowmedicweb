...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="container">
    <a class="navbar-brand fw-bold" href="#page-top">
        <img src="landing/img/judul_kucing.jpg" alt="Meow Medic Logo" class="me-2" style="height: 30px; width: auto;">
        Meow Medic
    </a>
...
<header>
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active" style="background-image: url('{{asset('landing/img/kucing.jpg')}}')">
              ...
              <div class="container-fluid px-5 enlarged-container-fluid">
                  <div class="row gx-5 justify-content-center enlarged-row">
                      <div class="col-md-10 text-center enlarged-text-center">
                          ...
                          <p class="text-muted mb-0 enlarged">We're committed to offering cat owners a reliable resource for understanding their pets' health. Our app provides advanced filters for quick diagnosis searches and access to veterinarian-approved illness information. Easily manage your cat's health with streamlined user directories and detailed diagnosis history. Make informed decisions and ensure your feline friend receives the care they need. With our cat illness information app, caring for your cat has never been easier.</p>
                      </div>
                  </div>
              </div>
          </div>
    ...
    <div class="container px-5">
        ...
        <div class="row gx-5 justify-content-center">
          <div class="col-12 text-center mb-5">
              <h2 class="display-4 lh-1 mb-4" style="color: #000000; font-weight: bold;">MeowMedic. Your Go-To Cat Diagnosis and Health Management Solution</h2>
          </div>
      </div>
        ...
        <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
            <div class="col-sm-8 col-md-6">
                <div class="bg-dark text-black p-3 mb-4" style="border-radius: 20px">
                    ...
                    <p class="lead fw-normal mb-5 mb-lg-0" style="color: #ffffff">Filters and check newly added illnesses diagnosis from veterinarian. Quickly access diagnosis lists and user directories for efficient management.</p>
                    <button class="btn btn-primary"  style="border-radius: 20px; background-color: #85868C;">Hire international talent</button>
            ...
            <div class="col-sm-8 col-md-6">
                <div class="bg-dark text-white p-3 mb-4" style="border-radius: 20px">
                    ...
                    <p style="color: #ffffff;">Access a list of diagnosis histories, allowing them to review and update information as necessary.</p>
                    <button class="btn btn-primary" style="border-radius: 20px; background-color: #85868C;">Convert contractors</button>
                </div>
                
                
                <div class="bg-dark text-black p-3 mb-4" style="border-radius: 20px">
                    <h3 class="mb-4" style="color: #ffff;">Users on mobile</h3>
                    <p style="color: #ffffff">Utilize diagnoses for informed health decisions and access detailed diagnosis history for personal health management.</p>
                    <button class="btn btn-primary" style="border-radius: 20px; background-color: #85868C;">Convert contractors</button>
                </div>
            </div>
        </div>
